...
public class HealthCare {
    ...
    List<HealthCare> healthcareproviderList = new ArrayList<>();

int getSize() {return healthcareproviderList.size();}

    public HealthCare getItem(int i) {
        if (i >= 0 && i < healthcareproviderList.size())
            return  healthcareproviderList.get(i);
        else
        return null;
    }
